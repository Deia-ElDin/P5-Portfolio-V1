...
import { IoMdCodeWorking, IoLogoHtml5, IoLogoCss3, IoLogoNodejs } from 'react-icons/io';
import { SiJavascript, SiRedux, SiReact, SiTestinglibrary } from 'react-icons/si';
import { DiSass } from 'react-icons/di';
import { GoLocation } from 'react-icons/go';
import { MdSchool, MdOutlineLanguage, MdEmail } from 'react-icons/md';
...
const myData = {
  ...
  skills: [
    ...
    },
    {
      ...
      lvl: 'Intermediate',
      percentage: 70,
      icon: <SiReact className="info-icon" data-testid="skill-icon" />,
    },
    {
  ...
  projects: {
    ...
    array: [
      ...
      },
      {
        ...
        github: 'https://github.com/DeiaHamad/Project-2-Chrome-Save-Url-Extension',
        technology: [
          {
            lang: 'Html',
            icon: <IoLogoHtml5 className="project-icon" />,
      ...
      },
      {
        id: 'p6',
        title: 'CourseTube-V3',
        liveDeom: 'https://deiahamad.github.io/Project-6-CourseTube-Version-3/',
        github: 'https://github.com/DeiaHamad/Project-6-CourseTube-Version-3',
        technology: [
          {
            lang: 'Html',
            icon: <IoLogoHtml5 className="project-icon" />,
          ...
          {
            lang: 'Redux',
            icon: <SiRedux className="project-icon" />,
            codeLines: 476,
          },
          {
            lang: 'React',
        ...
        duration: handleProjects('July 22, 2022', 'July 30, 2022'),
      },
      {
        id: 'p7',
        title: 'CourseTube-V4',
        liveDeom: 'https://deiahamad.github.io/Project-7-CourseTube-V4-UI/',
        github: 'https://github.com/DeiaHamad/Project-7-CourseTube-V4-UI/tree/master',
        technology: [
          {
            lang: 'Html',
            icon: <IoLogoHtml5 className="project-icon" />,
          ...
          {
            lang: 'Node',
            icon: <IoLogoNodejs className="project-icon" />,
            codeLines: 832,
          },
        ],
        startingDate: 'August 15, 2022',
        finishingDate: 'August 23, 2022',
        duration: handleProjects('August 15, 2022', 'August 23, 2022'),
      },
    ],
  },
  jobs: [
    ...
    },
    {
      ...
      startDate: '2017',
      endDate: '2018',
      description: 'Managing the work and ensuring delivery on time with good quality.',
      country: 'UAE',
    },
    {
      id: 'j5',
    ...
    socialMedia: [
      {
        ...
        icon: <AiFillLinkedin className="media-icon" data-testid="linkedin-icon" />,
      },
      {
        id: 'github',
...
function handleExperience() {
  ...
  const expInMonths = Math.floor((currentDate - startingDate) / 1000 / 30 / 60 / 60 / 24);
